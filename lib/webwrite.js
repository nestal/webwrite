...
function Load( href )
{
	...
	var find_hash	= (href 		== null	? -1	: href.indexOf('#') ) ;
	var hash		= (find_hash	== -1	? null	: href.substr(find_hash) ) ;
	if ( hash == null )
	{
...
function UpdateProperties(href)
{
...
function Properties( )
{
	...
	{
		UpdateProperties( location.href ) ;
	}
}
